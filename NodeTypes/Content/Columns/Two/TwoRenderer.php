...
namespace Neos\Demo\NodeTypes\Content\Columns\Two;

use Neos\ContentRepository\Core\SharedModel\Node\NodeName;
use Neos\Demo\Components\Columns\TwoColumns;
...
class TwoRenderer implements ContentNodeRendererInterface
{
    ...
    {
        return TwoColumns::create(ComponentCollection::list(
